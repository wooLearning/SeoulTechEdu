# VerilogProject
> Verilog-based FPGA integration projects and source archive
...
| 경로 | 설명 |
| --- | --- |
| [SourceCode](./SourceCode) | Verilog RTL, testbench, constraint 파일이 모여 있는 실질적인 소스 폴더 |
...
- `watch_top.v`: clock / stopwatch 표시 로직 래퍼
