# Active default regression program for `tb_top` / `src/InstrRom.sv`
# This is the active pipeline reference copy, rewritten in the same style as `tb/legacy/test.s`.
...
# 2. R-type ALU Test
add  x4, x1, x2                 # PC=12: x4 = 15 + 3 = 18
sub  x5, x1, x2                 # PC=16: x5 = 15 - 3 = 12
sll  x6, x1, x2                 # PC=20: x6 = 15 << 3 = 120
slt  x7, x3, x1                 # PC=24: x7 = signed(-16 < 15) = 1
sltu x8, x3, x1                 # PC=28: x8 = unsigned(0xFFFFFFF0 < 15) = 0
xor  x9, x1, x2                 # PC=32: x9 = 15 ^ 3 = 12
srl  x10, x1, x2                # PC=36: x10 = 15 >> 3 = 1
sra  x11, x3, x2                # PC=40: x11 = -16 >>> 3 = -2
or   x12, x1, x2                # PC=44: x12 = 15 | 3 = 15
and  x13, x1, x2                # PC=48: x13 = 15 & 3 = 3

# 3. I-type ALU Test
addi  x14, x1, 5                # PC=52: x14 = 20
slti  x15, x3, 0                # PC=56: x15 = signed(-16 < 0) = 1
sltiu x16, x3, 1                # PC=60: x16 = unsigned(0xFFFFFFF0 < 1) = 0
xori  x17, x1, 3                # PC=64: x17 = 12
ori   x18, x1, 2                # PC=68: x18 = 15
andi  x19, x1, 7                # PC=72: x19 = 7
slli  x20, x2, 4                # PC=76: x20 = 48
srli  x21, x1, 1                # PC=80: x21 = 7
srai  x22, x3, 2                # PC=84: x22 = -4

# 4. Word Memory Access Test
addi x23, x0, 64                # PC=88: x23 = data base address 64
sw   x14, 0(x23)                # PC=92: Mem[64] = 20, word[16] = 20
lw   x24, 0(x23)                # PC=96: x24 = Mem[64] = 20

# 5. Branch Taken / Not-Taken Test
addi x25, x0, 0                 # PC=100: x25 = not-taken counter = 0
addi x26, x0, 0                 # PC=104: x26 = taken counter = 0
...
addi x27, x27, -1               # PC=236: pass1 -> 1, pass2 -> 0
bne  x27, x0, -4                # PC=240: pass1 taken to PC=236, pass2 not taken
addi x28, x28, 1                # PC=244: x28 = 1 after loop exits

# 7. Byte / Halfword Memory Access Test
addi x23, x0, 68                # PC=248: x23 = byte/halfword base
...
sh   x2,  2(x23)                # PC=280: Mem[70:71] = 0xF234, word[17] = 0xF2347F80
...
.word 0xFFFFFFFF                # PC=300: unsupported instruction, no reg/mem side-effect expected
...
nop                             # PC=332: fetch observed at completion
