...
![Top Module Overview](md/visuals/diagrams/top_module_overview.svg)
...
![Program Flow](md/visuals/figures/test_peri_repeat_program_flow.svg)

UART class 기반 검증 구조:

![UART Class Structure](md/visuals/figures/uart_peri_tb_class_structure.svg)
